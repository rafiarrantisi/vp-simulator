...
def build_judge_prompt(case: CaseV2, transcript: list[dict], mode: str,
    ...
    system = (
        ...
        "across multiple specialties, and know exactly what a safe, competent, independent "
        "practitioner looks like. You are rigorous, fair, and evidence-based.\n\n"
        "Your job is to assess this candidate's performance against the explicit mark "
        "scheme provided in the GROUND TRUTH. You do NOT inflate scores. You grade "
        "the way a real examiner grades: conservatively, honestly, and with a clear "
        "rationale for every mark.\n\n"
        "=== SCORING PRINCIPLES ===\n"
