...
// ===== BEGIN inline App (from Virtual Patient Simulator.html) =====
    ...
    function App() {
      ...
      return React.createElement(React.Fragment, null,
        ...
        React.createElement('main', { key: screenKey, style: { flex: 1, paddingBottom: isMobile ? 70 : 0, position: 'relative', zIndex: 1 } },
          ...
          screen === 'cases' && !/^#\/v3(?:\/|$)/.test(window.location.hash || '') && React.createElement(V3Boundary, { key: 'cases-shell', onReset: function(){ navigate('dashboard'); } }, React.createElement(QoraV3App, null)),
          /^#\/v3(?:\/|$)/.test(window.location.hash || '') && React.createElement(V3Boundary, { key: 'v3-shell-' + screenKey, onReset: function(){ navigate('cases'); } }, React.createElement(QoraV3App, null)),
    ...
    // DEBUG-only error boundary to surface hidden render errors (removed before final).
    if (!window.__QoraErrorBoundary) {
      window.__QoraErrorBoundary = class extends React.Component {
        constructor(p) { super(p); this.state = { e: null }; }
        static getDerivedStateFromError(e) { return { e: e }; }
        componentDidCatch(e) { window.__lastRenderErr = String((e && e.message) || e); }
        render() {
          if (this.state.e) return React.createElement('div', { style: { padding: 40, color: 'var(--red-d)', fontSize: 14, whiteSpace: 'pre-wrap' } },
            'RENDER ERROR: ' + String((this.state.e && this.state.e.message) || this.state.e));
          return this.props.children;
        }
      };
    }
    window.__qoraRoot.render(React.createElement(window.__QoraErrorBoundary, null, React.createElement(App)));
