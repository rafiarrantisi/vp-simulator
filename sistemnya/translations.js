...
window.QORA_TRANSLATIONS = {
  ...
  'session.scoring': { en: 'Scoring', id: 'Menilai' },
  'session.scoring_progress': { en: 'Scoring… {n}s — the judge is reading your full interview and mapping it to the rubric.', id: 'Menilai… {n}s — juri sedang membaca seluruh wawancara Anda dan memetakannya ke rubrik.' },
  'session.score_timeout': { en: 'Scoring took too long and was stopped. Your answers are saved — please try again.', id: 'Penilaian terlalu lama dan dihentikan. Jawaban Anda tersimpan — silakan coba lagi.' },
  'session.score_failed': { en: 'The AI judge could not finish scoring. Your answers are saved — try again.', id: 'Juri AI gagal menyelesaikan penilaian. Jawaban Anda tersimpan — coba lagi.' },
